...
class Nico {
    ...
    async init(inputConfig = {}) {
        const config = utility_1.mergeDeep(config_1.default, inputConfig);
        ...
        app.use(custom_handler_1.default(config));
        this.db = new db_1.DB(config.datastores);
        const router = new router_1.default();
        app.use(routes_1.default(router, config));
